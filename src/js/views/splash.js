function init_splash(){
    ...
    vertex3d.prototype = {
        ...
        var textSet = [
            {text:"WHAT", sphereRadius:140, sphereSpace:80, unitTime:100, time:1000},
            {text:"TO", sphereRadius:120, sphereSpace:70, unitTime:120, time:4000},
            {text:"WATCH", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
        ...
        var bg= document.getElementById('splash-cont');
        ...
        var start = function() {
            ...
            var refreshIntervalId=setInterval(function() {
                ...
                update();
                draw();
                if(document.getElementById('splash-cont').style.display=='none')
                {
                    clearInterval(refreshIntervalId);
                    console.log('splash has stopped running');
